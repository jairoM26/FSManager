...
verifyNumber (x:numberList)
	| null numberList && ( x `elem` ['0'..'9'] ) = True
...
verifyUserAndGroupChown :: String -> Bool
verifyUserAndGroupChown ("") = False
verifyUserAndGroupChown (tmp:command)
	| tmp == ':' = True
	| otherwise = verifyUserAndGroupChown (command)

---------------MKDIR FUNCTIONS---------------------
--------update directories when there are one been created
...
--------update files when there are one been created
...
findFileByPath :: ([(String,String,String,String,String,String)],String)-> Bool
findFileByPath ([], fileName) = False
findFileByPath (tmp:fileList,fileName)
	| fileName == sel2 tmp = True
	| otherwise = findFileByPath(fileList,fileName)
...
getDirByCD :: ([(String,String,[String],[String],String,String,String,String,String,Bool)],String)->(String,String,[String],[String],String,String,String,String,String,Bool)
getDirByCD (tmp:directoriesList,cd)
	| cd == sel2 tmp = tmp
	| otherwise = getDirByCD(directoriesList,cd)
...
getFile :: ([(String,String,String,String,String,String)],String)->(String,String,String,String,String,String)
getFile (tmp:fileList,fileName)
	| fileName == sel1 tmp = tmp
	| otherwise = getFile (fileList,fileName)

getFileByPath :: ([(String,String,String,String,String,String)],String)->(String,String,String,String,String,String)
getFileByPath (tmp:fileList,fileName)
	| fileName == sel2 tmp = tmp
	| otherwise = getFileByPath (fileList,fileName)
